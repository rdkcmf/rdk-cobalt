...
class WpePlatformConfig(platform_configuration.PlatformConfiguration):
  ...
  def GetVariables(self, configuration):
    ...
    variables.update({
        ...
        'architecture_gypi':
             'third_party/starboard/wpe/brcm/arm/architecture_buildroot.gypi',
    })
...
class WpePlatformConfigForYocto(platform_configuration.PlatformConfiguration):
  ...
  def GetVariables(self, configuration):
    ...
    variables.update({
        ...
        'cobalt_enable_jit': 1,
        'architecture_gypi':
             'third_party/starboard/wpe/brcm/arm/architecture_yocto.gypi',
    })
    return variables
...
def CreatePlatformConfig():
  if 'BUILDROOT_HOME' in os.environ:
    ...
    return WpePlatformConfigForYocto('wpe-brcm-arm')
