...
// The Starboard configuration for a wpe implementation designed to be
// built on wpe platforms.

#ifndef THIRD_PARTY_STARBOARD_WPE_RPI_CONFIGURATION_PUBLIC_H_
#define THIRD_PARTY_STARBOARD_WPE_RPI_CONFIGURATION_PUBLIC_H_
...
#define SB_PLATFORM_BRAND_NAME "Unknown"
