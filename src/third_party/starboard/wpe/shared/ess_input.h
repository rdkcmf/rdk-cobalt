...
#ifndef THIRD_PARTY_STARBOARD_WPE_SHARED_ESS_INPUT_H_
#define THIRD_PARTY_STARBOARD_WPE_SHARED_ESS_INPUT_H_
...
#endif  // THIRD_PARTY_STARBOARD_WPE_SHARED_ESS_INPUT_H_
